...
Логика игрового сюжета: ![Логика игрового сюжета](https://disk.yandex.ru/client/disk/Бот-квест/schemes?idApp=client&dialog=slider&idDialog=%2Fdisk%2FБот-квест%2Fschemes%2FThe_logic_of_the_game.png)   
...
Структура бота с функциями: ![Структура бота с функциями](https://disk.yandex.ru/client/disk/Бот-квест/schemes?idApp=client&dialog=slider&idDialog=%2Fdisk%2FБот-квест%2Fschemes%2FBot_structure_with_functions.jpg)   
### **3. Принцип работы бота** 
Принцип работы бота: ![Принцип работы бота](https://disk.yandex.ru/client/disk/Бот-квест/schemes?idApp=client&dialog=slider&idDialog=%2Fdisk%2FБот-квест%2Fschemes%2FHow_the_bot_works.jpg)  

### **4. Общее решение** 
Общее решение: ![Общее решение](https://disk.yandex.ru/client/disk/Бот-квест/schemes?idApp=client&dialog=slider&idDialog=%2Fdisk%2FБот-квест%2Fschemes%2FThe_general_solution.jpg)  
...
- Мы должны в самом проекте создать папку «Image» и положить в него картинки. Для этого можно перейти в [облачное хранилище](https://disk.yandex.ru/d/WrIZl5TyDSA1qw). Скачиваем и помещаем. Все изображения сгенерированы нейросетью [Kandinsky](https://fusionbrain.ai/?ref=vc.ru) 
