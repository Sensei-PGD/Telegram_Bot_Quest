...
Логика игрового сюжета: ![Логика игрового сюжета](https://disk.yandex.ru/i/vDwUxpBvxWfkdA/The_logic_of_the_game.png) 
...
Структура бота с функциями: ![Структура бота с функциями](https://disk.yandex.ru/i/Tzom49Qby5-7eA) 
### **3. Принцип работы бота** 
Принцип работы бота: ![Принцип работы бота](https://disk.yandex.ru/i/JpVv3ZV8ti8mhg)  

### **4. Общее решение** 
Общее решение: ![Общее решение](https://disk.yandex.ru/i/p67i4jDN9A0uLg) 
