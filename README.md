...
Логика игрового сюжета: ![Логика игрового сюжета]( https://disk.yandex.ru/i/02FhEUc5JHB6JQ)
...
Структура бота с функциями: ![Структура бота с функциями](https://disk.yandex.ru/i/8saa-_2IojKQVA) 
### **3. Принцип работы бота** 
Принцип работы бота: ![Принцип работы бота]( https://disk.yandex.ru/i/kHkZs2xlOrZ6rA)

### **4. Принцип работы бота** 
Принцип работы бота: ![Принцип работы бота](https://disk.yandex.ru/i/HPdeMtJGufSYHw)
...
Мы должны в самом проекте создать папку «Image» и положить в него картинки. Для этого можно перейти в [облачное хранилище](https://disk.yandex.ru/d/WrIZl5TyDSA1qw). Скачиваем и помещаем. 
