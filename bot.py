...
def say_info(message):
    bot.send_message(message.chat.id, "\nBot_Quest — это телеграмм-бот с текстовой RPG-игрой, которая позволит игрокам взаимодействовать и принимать решения.\n"
                                      ...
                                      "\nБолее подробно об игре вы можете узнать по этой ссылке: (Можете добавить свой источник)\n"
